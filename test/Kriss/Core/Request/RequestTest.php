...
use Kriss\Core\Request\Request as Request;
...
class RequestTest extends \PHPUnit\Framework\TestCase {
    ...
    function testGetPost()
    {
        ...
        $this->assertSame($_GET, $request->getQuery());
        $this->assertSame($_POST, $request->getRequest());
        $this->assertSame($_GET['id'], $request->getQuery('id'));
        $this->assertSame($_POST['name'], $request->getRequest('name'));
        $this->assertSame('default', $request->getQuery('foo', 'default'));
        $this->assertSame('default', $request->getRequest('foo', 'default'));
    }
}
